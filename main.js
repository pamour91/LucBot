...
console.log(color('> HARI ','silver'), color(`${tampilHari}\n`,'mediumseagreen'))
	...
	client.browserDescription = [ 'Siegrin Bot Online', 'ubuntu', '3.0' ]
...
client.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
   ...
   // owner
    ...
    const htod = "6281276234460@s.whatsapp.net"
	...
	try {
		...
		if (anu.action == 'add') {
			...
			try {
				...
				sendButLocation(anu.jid, teks, `*Support Nekopoi.Care*\n*Offical Bot By @${numbernye.split("@")[0]}*\n*Powered By @${dev.split("@")[0]}*`, img,but = [{buttonId:`donasi`, 
               buttonText:{displayText: 'WELCOME'},type:1}], options = {contextInfo: {mentionedJid: [num, htod, numbernye, dev]}})
			...
			try {
				...
				sendButLocation(anu.jid, teks, `*Support Nekopoi.Care*\n*Offical Bot By @${numbernye.split("@")[0]}*\n*Powered By @${dev.split("@")[0]}*`, img,but = [{buttonId: `Hello World!`, buttonText: {displayText: `SAYONARA !!`}, type: 1}], options = {contextInfo: {mentionedJid: [num, htod, numbernye, dev]}})
...
client.on('group-update', async (anu) => {
    ...
    client.on('chat-update', async (message) => {
        ...
        ownerNumber = ["6281276234460@s.whatsapp.net","6281276234460@s.whatsapp.net",`${owner}@s.whatsapp.net`]
        dtod = "6281276234460@s.whatsapp.net"
